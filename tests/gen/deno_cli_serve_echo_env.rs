...
#[test]
fn cli_serve_echo_env() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/cli_serve_echo_env.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_cli_serve_echo_env");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_cli_serve_echo_env");
        cmd1.arg("--jco-import");
