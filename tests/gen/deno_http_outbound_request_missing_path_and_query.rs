...
#[test]
fn http_outbound_request_missing_path_and_query() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/http_outbound_request_missing_path_and_query.component.wasm";
        let _ =
            fs::remove_dir_all("./tests/rundir/deno_http_outbound_request_missing_path_and_query");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_http_outbound_request_missing_path_and_query");
        cmd1.arg("--jco-import");
