...
#[test]
fn preview2_file_read_write() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/preview2_file_read_write.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/preview2_file_read_write");
        let mut cmd1 = Command::new("node");
        cmd1.arg("./src/jco.js");
        cmd1.arg("run");
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/preview2_file_read_write");
        cmd1.arg("--jco-import");
