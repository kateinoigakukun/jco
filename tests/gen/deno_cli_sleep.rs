...
#[test]
fn cli_sleep() -> anyhow::Result<()> {
    #[cfg(not(windows))]
    {
        let wasi_file = "./tests/gen/cli_sleep.component.wasm";
        let _ = fs::remove_dir_all("./tests/rundir/deno_cli_sleep");
        ...
        cmd1.arg("--jco-dir");
        cmd1.arg("./tests/rundir/deno_cli_sleep");
        cmd1.arg("--jco-import");
